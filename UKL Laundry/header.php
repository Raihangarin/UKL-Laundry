...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="box-shadow: 4px 4px 5px -4px;">
      ...
      <a href="https://imgbb.com/"></a>
        <a class="navbar-brand" href="home.php">TEST LAUNDRY</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link btn-outline-primary rounded-pill px-3" aria-current="page" href="tampil_paket.php">Paket</a>
            </li>
            <li class="nav-item">
